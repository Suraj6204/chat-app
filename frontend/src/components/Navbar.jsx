              ...
              <div className="bg-base-300 p-6 flex flex-col gap-4 relative">
                ...
                >
                  <div className="flex flex-col select-none">
                    ...
                    <span className="text-[13px] text-success font-medium">
                      {authUser.username || "#set-your-username"}
                    </span>
                  </div>
                  <ChevronDown
                    className={`size-5 text-base-content/70 transition-transform duration-200 ${isProfileOpen ? "rotate-180" : ""}`}
                  />
                </div>
                ...
                <div
                  className={`flex flex-col overflow-hidden transition-all duration-300 ease-in-out -mx-2 bg-base-100 rounded-lg mt-1 ${
                    isProfileOpen
                      ? "max-h-40 opacity-100 border border-base-300"
                      : "max-h-0 opacity-0"
                  }`}
                >
                  <Link
                ...
                <li>
                  ...
                  >
                    <div className="flex items-center gap-5">
                      {isDark ? (
                        <Moon className="size-5.5 text-base-content/60" />
                      ) : (
                        <Sun className="size-5.5 text-base-content/60" />
                      )}
